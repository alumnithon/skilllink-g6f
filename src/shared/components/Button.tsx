...
export const ButtonPrimary = ({ title, styles, onClick, icon }: ButtonProps) => {
  return (
    <button
      type="submit"
      onClick={onClick}
    ...
    >
      {icon && <span className="w-[0.9375rem] h-[0.9375rem] flex items-center">{icon}</span>}
      {title}
    </button>
  );
};

export const ButtonSecondary = ({ title, styles, onClick, icon }: ButtonProps) => {
  return (
    <button
      type="button"
      onClick={onClick}
...
export const ButtonProfileOption = ({ title, styles, onClick, icon }: ButtonProps) => {
  return (
    <button
      type="button"
      onClick={onClick}
