...
const Sidebar = () => {
  ...
  return (
    ...
    {isMobileOpen && (
      ...
      >
        <aside
          className="bg-white w-[220px] h-full p-4 flex flex-col shadow-xl"
 ...
 <aside className="w-[220px] bg-white flex flex-col h-auto lg:h-auto md:h-[calc(100vh-4rem-3rem)] md:overflow-y-auto md:scrollbar-none hidden lg:flex">
